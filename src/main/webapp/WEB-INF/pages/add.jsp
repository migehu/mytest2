    ...
    <script>
        ...
        $(function () {
            $.ajax({
                ...
                success:function (data) {
                   for(var i=0;i<data.length;i++){
                       $("#address").append("<option value='"+data[i].id+"'>"+data[i].city+"</option>");
                   }
                }
            })
        })
...
<div class="container">
    ...
    <form action="${pageContext.request.contextPath}/user/saveUser" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input type="file" class="form-control" id="picName" name="picName"/>
        </div>
        <div class="form-group">
            <label>性别：</label>
        ...
        <div class="form-group">
            ...
            <select name="addressId" class="form-control" id="address">
            </select>
        </div>
